...
const handler = async (m, {conn, text, usedPrefix, command}) => {
  if (!text) throw `*📍 Ingrese un texto para buscar, Ejemplo: ${usedPrefix + command} NauticaBot-MD*`;
